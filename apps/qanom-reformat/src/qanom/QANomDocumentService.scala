...
// case class QANomDocumentService[M[_]](f: DotKleisli[M, QANomDocumentService.Request]) {
//   import QANomDocumentService._
//   def getQANomIndex: M[QANomIndex] = f(GetDataIndex)
...
//   ) = new DotKleisli[Id, QANomDocumentService.Request] {
